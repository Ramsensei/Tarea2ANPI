function [xk,k,eabs] = parte1_p3(A,b,xk,iterMax,tol, procs)
...
% procs = Número de procesadores a utilizar
...
xk1 = zeros(n,1);
for k = 1:iterMax
    fun = @(i) (1/A(i,i))*(b(i) - A(i,:)*xk + A(i,i)*xk(i));
    xk1 = transpose(pararrayfun(procs, fun, [1:n]));
    xk = xk1;
    eabs = norm(A*xk - b);
    if eabs < tol
        k = k+1;
